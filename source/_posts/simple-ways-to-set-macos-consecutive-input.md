---
title: macOS 长按连续输入的简单设置方法
subtitle: Simple Ways to Set macOS Consecutive Input
catalog: true
date: 2018-08-02
tags: [Macintosh, Tips]
---
...
![consecutive_input_pic][consecutive_input_pic]
...
[consecutive_input_pic]: ./img_consecutive_input.png
